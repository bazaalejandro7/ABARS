...
public class LoginGUI extends JFrame{
	 ...
	 * 
	 * Edited Dec 2 by Courtney Fennell: added image to login screen and changed layout manager
	 */
...
>>>>>>> be254b7fc35a3241c8c8d7ebab086eb8867c1577
		...
		public void actionPerformed(ActionEvent e){
			...
			try{
				...
				if(tempStudent!=null){
					...
					ImageIcon image = new ImageIcon(getClass().getResource("youshallnotpass.gif"));
